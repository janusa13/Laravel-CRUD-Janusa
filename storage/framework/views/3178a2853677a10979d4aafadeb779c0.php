    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <a href="<?php echo e(route('student.addAssists', ['id' => $student->id])); ?>" class="btn btn-success btn-sm my-2"><i  class="bi bi-pencil-square""></i>Add asssit manual</a>
...
<?php echo $__env->make('../dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel-CRUD-Janusa\resources\views/student/showAddAssist.blade.php ENDPATH**/ ?>