...
>
    ...
    <div
        x-show="show"
        class="mb-6  dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\laragon\www\Laravel-CRUD-Janusa\resources\views/components/modal.blade.php ENDPATH**/ ?>